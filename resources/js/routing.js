(function () {
    ...
    if (window.location.href == "https://purple-winds-yxnj49ux4a.ploi.dev/") {
        let schedulePath;
        if (window.localStorage.getItem("team")) {
            if (localStorage.getItem("scheduleWidgetValue")) {
                ...
                window.location.href = `https://purple-winds-yxnj49ux4a.ploi.dev/${localStorage.getItem(
                    "team"
                )}/${schedulePath}`;
            } else {
                window.location.href = `https://purple-winds-yxnj49ux4a.ploi.dev/${localStorage.getItem(
            ...
            window.location.href = "https://purple-winds-yxnj49ux4a.ploi.dev/boys-jv/u";
        }
    }
    ...
    teamSelect.addEventListener("click", (e) => {
        ...
        if (!pagesNotTeamDependent.includes(pathArray[1])) {
            ...
            window.location.href = `https://purple-winds-yxnj49ux4a.ploi.dev${finishedPath}`;
        } else {
    ...
    scheduleSelectorBtns.forEach((btn) => {
        btn.addEventListener("click", () => {
            ...
            window.location.href = `https://purple-winds-yxnj49ux4a.ploi.dev/${team}/${schedulePath}`;
        });
    });
})();
